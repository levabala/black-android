...
Откройте настройки истории использования и найдите Black. Если доступ помечен как **«Запрещено»**, а Android не даёт включить переключатель из-за ограниченных настроек, выполните следующие шаги.

![Black помечен как запрещённый в настройках истории использования](../app/src/main/res/drawable-nodpi/guide_denied_ru.png)
...
![Страница сведений о Black в настройках Android](../app/src/main/res/drawable-nodpi/guide_app_info_ru.png)

## Шаг 4. Включите доступ к истории использования

Вернитесь в Black и нажмите **«Предоставить доступ к истории использования»**. Выберите Black и включите переключатель **«Разрешить доступ к статистике использования»**. Если переключатель недоступен, повторите шаг 3.

![Выключенный переключатель доступа к статистике использования](../app/src/main/res/drawable-nodpi/guide_usage_blocked_ru.png)
